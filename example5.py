...
def build_rocketsim_env():
    ...
    # rewards_to_combine = (DistributeRewards(EventReward(team_goal=1.25, touch=0.2, demo=0.3, boost_pickup=0.1), 0.3),
    ...
    rewards_to_combine = (EventReward(team_goal=1.5, touch=0.001, demo=0.3, boost_pickup=0.1),
                          VelocityPlayerToBallReward(),
                          VelocityBallToGoalReward(),
                          FaceBallReward()
                          )
    reward_weights = (10.0, 0.1, 0.25, 0.005)
...
if __name__ == "__main__":
    ...
    last_checkpoint_num = max(os.listdir("data/checkpoints/rlgym-ppo-run-1714023982857569800/"), key=lambda d: int(d))
    checkpoints_load_dir = "data/checkpoints/rlgym-ppo-run-1714023982857569800/" + str(last_checkpoint_num)
